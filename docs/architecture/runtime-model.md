...
See [Gap Analysis](./gap-analysis.md) and [Expansion Proposal](./expansion-proposal.md). Platform polish items (G12–G14, G17 wlroots session) remain; critical path gaps G1/G6/G16 and D-Bus adapter G7 are closed.
