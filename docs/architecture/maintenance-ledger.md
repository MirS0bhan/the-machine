...
|------------|--------|-----|--------|---------|-------|
| audit event-bus clippy/dead-code | cursor/maintenance-audit-event-bus-clippy-05da786 | — | pr-open | 2026-08-30 | unused mut, type alias, is_none_or, += |
...
|------------|----------|--------|---------|
| 2026-08-30 | audit | event-bus clippy/dead-code | pr-open |
...
2. **G13** — operator target-HW validation on installed rootfs (software checks complete; PR #168 open)
3. **audit** — ui-runtime or mcp-bus clippy/dead-code (PRs #162/#166 open for MCP tests)
