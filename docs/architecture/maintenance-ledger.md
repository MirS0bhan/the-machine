...
|------------|--------|-----|--------|---------|-------|
| audit ui-runtime MCP handler tests | cursor/maintenance-audit-ui-runtime-mcp-05da786 | — | pr-open | 2026-08-30 | ui.status/get/patch/tree/auil.parse + unknown method |
...
3. **audit** — event-bus / local-model-daemon / lambda-server MCP handler unit tests
