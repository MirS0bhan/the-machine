...
|------------|--------|-----|--------|---------|-------|
| verify-fix resolve merge conflict markers & restore event-bus/src/main.rs | cursor/maintenance-verify-fix-merge-conflicts-d2bc9cb | — | pr-open | 2026-08-30 | resolve conflict markers in docs/scripts/agent-core, restore event-bus/src/main.rs |
...
|------------|----------|--------|---------|
| 2026-08-30 | verify-fix | resolve merge conflict markers & restore event-bus | pr-open |
