...
|------------|--------|-----|--------|---------|-------|
| verify-fix agent-core/event-bus merge conflicts | cursor/maintenance-verify-fix-agent-core-conflicts-da8f2b1 | — | pr-open | 2026-08-30 | restore tests + event-bus main.rs; resolve inventory/verify-docs conflicts |
...
|------------|----------|--------|---------|
| 2026-08-30 | verify-fix | agent-core/event-bus merge conflicts on main | pr-open |
