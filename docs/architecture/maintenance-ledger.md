...
|------------|--------|-----|--------|---------|-------|
| audit localmodel.complete integration test | cursor/maintenance-audit-localmodel-complete-integration-05da786 | #183 | pr-open | 2026-08-30 | policy-gated agent-core → local-model stub completion |
...
|------------|----------|--------|---------|
| 2026-08-30 | audit | localmodel.complete Python integration test | pr-open |
...
5. **audit** — marketplace.list integration test
