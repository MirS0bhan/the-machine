...
|------------|--------|-----|--------|---------|-------|
| verify-fix merge corruption on main | cursor/maintenance-verify-fix-merge-corruption-eb7fb38 | #205 | pr-open | 2026-08-30 | agent-core tests, event-bus main.rs, conflict markers |
...
|------------|----------|--------|---------|
| 2026-08-30 | verify-fix | agent-core tests + event-bus main + conflict markers | pr-open |
