...
|------------|--------|-----|--------|---------|-------|
| G13 installed-rootfs validation | cursor/maintenance-g13-target-hw-validate-05da786 | — | pr-open | 2026-08-30 | `validate-installed-rootfs.sh` + full systemd unit checks |
...
|------------|----------|--------|---------|
| 2026-08-30 | gap | G13 operator target-HW installed-rootfs validation | pr-open |
