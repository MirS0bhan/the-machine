...
|------------|--------|-----|--------|---------|-------|
| G17 wlroots scaffold | cursor/maintenance-g17-wlroots-scaffold-8d4febd | — | pr-open | 2026-08-30 | Backend selection + wlroots init plan; no wl_display yet |
...
|------------|----------|--------|---------|
| 2026-08-30 | gap | G17 wlroots scaffold | pr-open |
...
1. **G17** — compositor: bind wlroots display socket (next sub-step after scaffold)
