...
|------------|--------|-----|--------|---------|-------|
| audit event-bus MCP handlers | cursor/maintenance-audit-event-bus-mcp-05da786 | #163 | pr-open | 2026-08-30 | event.subscribe/publish/schedule/stats + unknown method |
| audit ui-runtime MCP handlers | cursor/maintenance-audit-ui-runtime-mcp-05da786 | #162 | pr-open | 2026-08-30 | ui.status/get/patch/tree/auil.parse + unknown method |
| audit local-model-daemon MCP handlers | cursor/maintenance-audit-local-model-daemon-mcp-05da786 | — | pr-open | 2026-08-30 | localmodel.health/complete/classify_intent/embed + unknown method |
...
3. **audit** — lambda-server MCP handler unit tests
