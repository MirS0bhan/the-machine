...
|------------|--------|-----|--------|---------|-------|
| verify-fix main merge corruption | cursor/maintenance-verify-fix-agent-core-tests-da8f2b1 | — | pr-open | 2026-08-30 | agent-core tests + event-bus main.rs + conflict markers |
...
|------------|----------|--------|---------|
| 2026-08-30 | verify-fix | agent-core tests + event-bus main.rs + merge conflicts | pr-open |
