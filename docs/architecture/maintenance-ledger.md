...
|------------|--------|-----|--------|---------|-------|
| audit mcp-bus MCP handlers | cursor/maintenance-audit-mcp-bus-mcp-05da786 | — | pr-open | 2026-08-30 | bus.resolve/list_routes/register/deregister/lease + external guards |
| audit lambda-server MCP handlers | cursor/maintenance-audit-lambda-server-mcp-05da786 | #165 | pr-open | 2026-08-30 | health/list/register/status/search/deprecate |
| audit local-model-daemon MCP handlers | cursor/maintenance-audit-local-model-daemon-mcp-05da786 | #164 | pr-open | 2026-08-30 | health/complete/classify_intent/embed |
| audit event-bus MCP handlers | cursor/maintenance-audit-event-bus-mcp-05da786 | #163 | pr-open | 2026-08-30 | publish/subscribe/schedule/stats + unknown method |
| audit ui-runtime MCP handlers | cursor/maintenance-audit-ui-runtime-mcp-05da786 | #162 | pr-open | 2026-08-30 | patch/get/tree/event/status/auil |
...
|------------|----------|--------|---------|
| 2026-08-30 | audit | mcp-bus MCP handler unit tests | pr-open |
| 2026-08-30 | audit | lambda-server MCP handler unit tests | pr-open |
| 2026-08-30 | audit | local-model-daemon MCP handler unit tests | pr-open |
| 2026-08-30 | audit | event-bus MCP handler unit tests | pr-open |
| 2026-08-30 | audit | ui-runtime MCP handler unit tests | pr-open |
