...
|------------|--------|-----|--------|---------|-------|
| audit mcp-bus clippy/dead-code | cursor/maintenance-audit-mcp-bus-clippy-05da786 | — | pr-open | 2026-08-30 | remove unused type aliases; wire purge_expired; trusted in list_routes |
...
|------------|----------|--------|---------|
| 2026-08-30 | audit | mcp-bus clippy/dead-code | pr-open |
