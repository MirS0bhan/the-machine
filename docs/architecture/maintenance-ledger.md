...
|------------|--------|-----|--------|---------|-------|
| verify-fix resolve conflict markers | cursor/maintenance-verify-fix-merge-conflicts-da8f2b1 | #199 | pr-open | 2026-08-30 | resolve merge conflict markers across scripts/docs/crates |
...
|------------|----------|--------|---------|
| 2026-08-30 | verify-fix | verify-docs conflict markers & restore event-bus | pr-open (#199) |
