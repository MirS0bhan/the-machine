...
|------------|--------|-----|--------|---------|-------|
| audit state-store clippy | cursor/maintenance-audit-state-store-clippy-05da786 | — | pr-open | 2026-08-30 | manual_flatten in sled list_prefix |
| audit agent-core MCP handler tests | cursor/maintenance-audit-agent-core-mcp-dd029fb | #158 | pr-open | 2026-08-30 | `agent.status`, `agent.cloud.status`, local_only_mode guards |
| audit ui-runtime MCP handler tests | cursor/maintenance-audit-ui-runtime-mcp-05da786 | #162 | pr-open | 2026-08-30 | ui.patch/get/tree/event/status/auil |
| audit event-bus MCP handler tests | cursor/maintenance-audit-event-bus-mcp-05da786 | #163 | pr-open | 2026-08-30 | event.publish/subscribe/schedule/register_handler |
| audit local-model-daemon MCP tests | cursor/maintenance-audit-local-model-daemon-mcp-05da786 | #164 | pr-open | 2026-08-30 | localmodel health/complete/classify/embed |
| audit lambda-server MCP handler tests | cursor/maintenance-audit-lambda-server-mcp-05da786 | #165 | pr-open | 2026-08-30 | health/list/register/status/search/deprecate |
...
| audit local-model-daemon clippy | cursor/maintenance-audit-local-model-daemon-clippy-05da786 | #167 | pr-open | 2026-08-30 | dead-code and warning cleanup |
| G13 target-HW validation | cursor/maintenance-g13-target-hw-validate-05da786 | #168 | pr-open | 2026-08-30 | operator installed-rootfs software checks |
...
|------------|----------|--------|---------|
| 2026-08-30 | audit | state-store clippy/dead-code | pr-open |
| 2026-08-30 | audit | state-store MCP handler unit tests | merged (#161) |
| 2026-08-30 | audit | agent-core MCP handler unit tests | pr-open (#158) |
...
2. **G13** — operator target-HW validation on installed rootfs (#168 in flight)
3. **audit** — compositor clippy/dead-code (`H` unused in bitmap_font.rs)
4. **audit** — missing MCP integration test in component-inventory.yaml
