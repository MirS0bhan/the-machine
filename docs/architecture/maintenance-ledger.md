...
|------------|--------|-----|--------|---------|-------|
| audit event-bus MCP handlers | cursor/maintenance-audit-event-bus-mcp-05da786 | — | pr-open | 2026-08-30 | event.publish/subscribe/schedule/register_handler + pattern_matches |
...
2. **audit** — ui-runtime or local-model-daemon MCP handler unit tests
