...
|------------|--------|-----|--------|---------|-------|
| audit lambda.search integration test | cursor/maintenance-audit-lambda-search-integration-05da786 | — | pr-open | 2026-08-30 | Python cross-component test + inventory mapping |
...
|------------|----------|--------|---------|
| 2026-08-30 | audit | lambda.search Python integration test | pr-open |
...
2. **audit** — missing Python integration test for another MCP method (e.g. `lambda.deprecate`, `policy.confirm`)
