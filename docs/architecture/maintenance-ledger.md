...
|------------|--------|-----|--------|---------|-------|
| audit agent-core MCP tests | cursor/maintenance-audit-agent-core-mcp-a009a9d | #158 | pr-open | 2026-08-30 | Clippy + handler unit tests for agent.* methods |
...
|------------|----------|--------|---------|
| 2026-08-30 | audit | agent-core MCP handler tests + clippy | pr-open |
...
3. **audit** — dead code / clippy in one crate (-p ui-runtime)
4. **audit** — MCP handler tests for ui-runtime or state-store
