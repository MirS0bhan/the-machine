...
|------------|--------|-----|--------|---------|-------|
| agentic desktop NOW honesty audit | cursor/scenarios-now-verify-ac5e | — | merged to main (`5d8ce82`) | 2026-08-31 | Independent audit; implemented remaining false-NOW chat phrases (voice/attach/skill/X11) + paste-replaces-selection |
...
|------------|----------|--------|---------|
| 2026-08-31 | audit | 1000-NOW catalog honesty vs boot Rust | merged to main (`5d8ce82`); 4 false-NOW phrases implemented |
