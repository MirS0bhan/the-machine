...
|------------|--------|-----|--------|---------|-------|
| audit event.subscribe integration | cursor/maintenance-audit-event-subscribe-integration-05da786 | — | pr-open | 2026-08-30 | policy-gated subscribe → publish delivery |
...
|------------|----------|--------|---------|
| 2026-08-30 | audit | event.subscribe integration test | pr-open |
...
3. **audit** — missing MCP integration test (e.g. `localmodel.complete`, `marketplace.list`)
